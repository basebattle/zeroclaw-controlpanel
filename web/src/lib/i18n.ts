...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'controlPanel.subtitle': 'Configure your ZeroClaw system',
    'controlPanel.footer_hint': 'For advanced configuration, use the Configuration page to edit raw TOML.',
    'controlPanel.overview.health': 'System Health',
    'controlPanel.overview.auto_refresh': 'Auto-refresh on page focus',
    'controlPanel.overview.system_info': 'System Information',
    'controlPanel.aiModels.temperature': 'Model Temperature',
    'controlPanel.aiModels.temperature_label': 'Temperature (0.0-2.0)',
    'controlPanel.aiModels.temperature_desc': 'Higher values make responses more creative but less consistent. Lower values make responses more focused.',
    'controlPanel.aiModels.registry': 'Model Registry',
    'controlPanel.aiModels.registry_desc': 'Add and configure your AI model providers.',
    'controlPanel.aiModels.no_models': 'No models configured. Add one to get started.',
    'controlPanel.aiModels.routing': 'Model Routing',
    'controlPanel.aiModels.routing_desc': 'Route specific task types to different models based on hints.',
    'controlPanel.aiModels.no_routes': 'No routes configured.',
    'controlPanel.aiModels.route_hint': 'Hint (e.g., "code", "analysis")',
    'controlPanel.aiModels.route_hint_placeholder': 'e.g. code, analysis',
    'controlPanel.aiModels.model_placeholder': 'Model ID or alias',
    'common.add': 'Add',
    'common.deploy': 'Deploy Changes',
    'common.saving': 'Saving...',
    'common.changes_saved': 'Changes saved',
  ...
  tr: {
    ...
    'nav.logs': 'Kayitlar',
    'nav.doctor': 'Doktor',
    'nav.control_panel': 'Kontrol Paneli',
